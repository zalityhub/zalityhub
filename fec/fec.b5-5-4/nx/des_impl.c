 ...
 * $Header: /home/hbray/cvsroot/fec/lib/nx/des_impl.c,v 1.2 2011/07/27 20:22:17 hbray Exp $
 *
 $Log: des_impl.c,v $
...
#ident "@(#) $Id: des_impl.c,v 1.2 2011/07/27 20:22:17 hbray Exp $ "
...
des_set_key(unsigned char *key, unsigned long *schedule)
{
	...
	for (i = 0; i < ITERATIONS; i++)
	{
		...
		s = des_skb[0][(c) & 0x3f] |
			...
			des_skb[2][((c >> 13) & 0x0f) | ((c >> 14) & 0x30)] | des_skb[3][((c >> 20) & 0x01) | ((c >> 21) & 0x06) | ((c >> 22) & 0x38)];
