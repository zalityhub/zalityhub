 ...
 * $Header: /home/hbray/cvsroot/fec/lib/nx/des_crypt.c,v 1.2 2011/07/27 20:22:17 hbray Exp $
 *
 $Log: des_crypt.c,v $
...
#ident "@(#) $Id: des_crypt.c,v 1.2 2011/07/27 20:22:17 hbray Exp $ "
 ...
 */
static int
common_crypt(char *key, char *buf, register unsigned len, unsigned mode, register struct desparams *desp)
{
	register int desdev;
 ...
 */
int
Cbc_Crypt(char *key, char *buf, unsigned int len, unsigned int mode, char *ivec)
{
	int err;
	struct desparams dp;
