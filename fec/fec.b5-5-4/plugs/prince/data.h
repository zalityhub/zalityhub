...
Filename:	lib/prince/data.h

Purpose:	Princess Message Set

			Compliance with specification: Princess
 ...
 * $Header: /home/hbray/cvsroot/fec/lib/prince/data.h,v 1.3.4.2 2011/09/24 17:49:50 hbray Exp $
 *
 $Log: data.h,v $
