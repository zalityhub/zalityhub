...
Filename:	lib/pcard/beginsession.c
 ...
 * $Header: /home/hbray/cvsroot/fec/lib/pcard/beginsession.c,v 1.3.4.2 2011/09/24 17:49:49 hbray Exp $
 *
...
#ident "@(#) $Id: beginsession.c,v 1.3.4.2 2011/09/24 17:49:49 hbray Exp $ "
 ...
 PiApiResult_t  BeginSession(PiSession_t * sess) 
{
	...
	memcpy(context->msgNa, (char[12][8])
	   {
		   "\0INVALD", "1CA_REQ", "1CA_RSP", "1BO_REQ", "1BO_RSP", "1BX_REQ", "1BX_RSP", "1BC_REQ", "1BC_RSP", "1BI_REQ", "1BI_RSP", "\0INVALD"
	   }, sizeof(context->msgNa));
...
// collect optional additional port translation arg
	context->altPort = sess->pub.service.properties.port;	// default
		...
		// look for fec.service.additional = |sp:6557
