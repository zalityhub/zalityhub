 ...
 * BtRecord_t would hold data (in a database)
...
/* Type representing a BtNode_t in the B+ tree.
 * This type is general enough to serve for both
 * the leaf and the internal BtNode_t.
 * The heart of the BtNode_t is the array
 ...
 *
 * In an internal BtNode_t, the first pointer
 * refers to lower BtNodes with keys less than
 ...
 *
 * In an internal BtNode_t, the number of valid
...
extern BtNode_t* BtFindLeaf(BtNode_t * root, unsigned long key, boolean verbose);
extern BtRecord_t* BtFind(BtNode_t * root, unsigned long key, boolean verbose);
...
extern BtNode_t* BtInsertIntoNodeAfterSplitting(BtNode_t * root, BtNode_t * old_node, int left_index, unsigned long key, BtNode_t * right);
...
extern BtNode_t* BtRedistributeNodes(BtNode_t * root, BtNode_t * n, BtNode_t * neighbor, int neighbor_index, int k_prime_index, int k_prime);
...
typedef int (*BtNodeWalker_t)(unsigned long key, BtRecord_t *rec, void *arg);
extern int BtNodeWalk(BtNode_t *node, BtNodeWalker_t walker, void *arg);
